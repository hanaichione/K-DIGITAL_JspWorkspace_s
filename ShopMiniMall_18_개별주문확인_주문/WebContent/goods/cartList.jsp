	...
	$(function() {
		...
		$(".updateBtn").on("click", function() {
			...
			$.ajax({
				...
				success : function(data, status, xhr) {//db에 업데이트성공 후 
					var sum = gAmount * gPrice;
					$("#sum" + num).text(sum); //가격*수량 후 변경 
				},
...
<table width="90%" cellspacing="0" cellpadding="0" border="0">
	...
	<form name="myForm">
		...
		<input type="hidden" name="gSize81" value="L" id="gSize81"> <input
			type="hidden" name="gColor81" value="navy" id="gColor81"> <input
			type="hidden" name="gPrice81" value="9800" id="gPrice81">

		<tr>
			<td class="td_default" width="80">
				<!-- checkbox는 체크된 값만 서블릿으로 넘어간다. 따라서 value에 삭제할 num값을 설정한다. --> <input
				type="checkbox" name="check" id="check81" class="check" value="<%=num%>">
			</td>
			...
			<td class="td_default" width="300" style='padding-left: 30px'><%=gName%><br>
				<font size="2" color="#665b5f">[옵션 : 사이즈(<%=gSize%>) , 색상(<%=gColor%>)]
			</font></td>
	...
	<tr>
		<td align="center" colspan="5"><a class="a_black"
			...
			<a class="a_black" href="#" id="delAllCart"> 선택 삭제하기1
		</a>&nbsp;&nbsp;&nbsp;&nbsp;
		<a class="a_black" href="#" id="delAllCart2"> 선택 삭제하기2
		</a>&nbsp;&nbsp;&nbsp;&nbsp;
		 <a class="a_black" href="main"> 계속
				쇼핑하기 </a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td height="20">
