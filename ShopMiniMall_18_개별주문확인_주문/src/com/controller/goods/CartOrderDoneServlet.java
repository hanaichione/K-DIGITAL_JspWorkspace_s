	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (dto != null) {
			...
			OrderDTO dto2 = new OrderDTO(0, userid, gCode, gName, Integer.parseInt(gPrice), gSize, gColor,
					Integer.parseInt(gAmount), gImage, orderName, post, addr1, addr2, phone, payMethod, null); // orderinfo
																												// insert
																												// 자료
			String orderNum = request.getParameter("orderNum"); // 장바구니에서 삭제할 번호

			System.out.println("dto2 === " + dto2);
			System.out.println("dto2 === " + orderNum);
