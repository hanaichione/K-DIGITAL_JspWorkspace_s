...
<script type="text/javascript">
	$(document).ready(function() {
		...
		}) // 유효성 검사 후 GoodsCartServlet으로 데이터 전달

		// +, - 버튼 클릭 시에 gAmount(구매 수량) 변동, 적용
		...
		<tr>
			<td>
				<table align="center" width="710" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td rowspan="7"><img
							src="images/items/<%=dto.getgImage()%>.gif" border="0"
					...
					<tr>
						...
						<td class="td_red" colspan="2" style='padding-left: 30px'><%=dto.getgPrice()%>
						</td>
					</tr>
					<tr>
